                ...
                <div class="col-lg-6">
                    ...
                    <nav aria-label="breadcrumb animated slideInDown">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="#">Catgeory</a></li>
...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="text-primary text-uppercase mb-2">Manage Category</h1>
            </div>
                ...
                <div class="container my-5 table-responsive newone" id="welcome">
                    ...
                    <tbody>
                        ...
                        <tr class="row_1 row_gray">
                            ...
                            <td>
                            <span ><img src="category_images/<?php echo $data['category_image']; ?>" class="img-thumbnail"
                                    height="100px" width="100px" ></span>
                            </td>
                            <td>
                                <a class="btn btn-success" href="update_category.php?id=<?php echo $data['id']?>"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="delete_category.php?id=<?php echo $data['id']?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php
                            $sno=$sno+1;
