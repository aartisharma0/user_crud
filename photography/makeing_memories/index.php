...
<div class="container-fluid hero-header bg-light py-5 mb-5">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <p class="text-primary text-uppercase mb-2 animated slideInDown">Welcome To Making Memories</p>
                <h1 class="display-4 mb-3 animated slideInDown">"Capturing Moments, Creating Memories: Your Journey Through the Lens"</h1>
                <p class="animated slideInDown">"Freezing Time, Unveiling Emotions: Where Every Click Tells a Story, and Every Frame Paints a Thousand Words."</p>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    ...
                    <p>"Unleashing Imagination Through the Lens: We're a collective of creative photographers dedicated to transforming ideas into captivating visual narratives."</p>
                    <p>"Elevating Creativity, One Shot at a Time: Join us on a visual journey where innovative photographers redefine the art of storytelling."</p>
        ...
        <div class="row g-3">
            <div class="col-lg-4 col-md-6 pt-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="fact-item bg-light text-center h-100 p-5">
                    ...
                    <span>
                        "Where Excellence Meets Vision: Explore the world through the eyes of award-winning photographers, where each frame is a masterpiece of artistry and innovation."</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="fact-item bg-light text-center h-100 p-5">
                    ...
                    <span>"A Decade in Frames: With years of experience, our photographers capture moments with a seasoned touch, turning memories into timeless treasures."</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pt-lg-5 wow fadeInUp" data-wow-delay="0.5s">
                <div class="fact-item bg-light text-center h-100 p-5">
                    ...
                    <span>"Crafting Smiles, Framing Joy: Our photographers' dedication to client happiness ensures that every shot taken is a moment cherished forever."</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-0 flex-sm-row">
                ...
                <div class="col-sm-6">
                    <div class="h-100 p-5 d-flex flex-column justify-content-between">
                        ...
                        <p>"Through the Lens of Artistry: Our photographers have a keen eye for beauty, transforming the ordinary into extraordinary visual stories."</p>
                        <div class="d-flex">
    ...
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="testimonial-item bg-white p-4">
                ...
                <p class="mb-0">"Through the Lens of Artistry: Our photographers have a keen eye for beauty, transforming the ordinary into extraordinary visual stories."</p>
            </div>
            <div class="testimonial-item bg-white p-4">
                <div class="d-flex align-items-center mb-4">
                ...
                <p class="mb-0">
"Nurturing Visions, Serving Dreams: Our photographers turn clients' ideas into reality, creating visual tales that resonate and memories that last."</p>
            </div>
            <div class="testimonial-item bg-white p-4">
                <div class="d-flex align-items-center mb-4">
