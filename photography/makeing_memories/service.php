            ...
            <?php
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex flex-column bg-light p-3 pb-0">
                        ...
                        <img class="img-fulid w-100"src="category_images/<?php echo $data['category_image']?>"  alt="..." height="300px" >

                            <div class="service-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="phoworkshow.php?name=<?php echo $data['category_name'] ?>"><i class="fa fa-link text-primary"></i></a>
                            </div>
                        </div>
