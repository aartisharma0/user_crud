...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="text-primary text-uppercase mb-2">Photographer Detail</h1>
            </div>
                ...
                <div class="container my-5 table-responsive newone" id="welcome">
                    ...
                    <tbody>
                        ...
                        <tr class="row_1 row_gray text-center">
                            ...
                            <td>
                            <span class=""><?php echo $data['email'];?></span>
                            </td>
                            <td>
                            <span class=""><?php echo $data['contact'];?></span>
                            </td>
                            <td>
                            <span class="text-wrap"><?php echo $data['address'];?></span>
                            </td>
                            <td>
                            <span ><img src="pho_images/<?php echo $data['image']; ?>" class="img-thumbnail"
                                    height="100px" width="100px" ></span>
                            </td>
                            <td>
                            <span class="text-wrap"><?php echo $data['description'];?></span>
                            </td>
                        </tr>
                        <?php
                            $sno=$sno+1;
