...
<div class="all-title-box">
    <div class="container text-center">
        <h1>Manage HOD<span class="m_1">"Empowering Voices, Inspiring Solutions: Campus Resolution Unleashed."</span></h1>
    </div>
</div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="row_1 row_gray">
                                                ...
                                                <td>
                                                    <span><img src="hod_images/<?php echo $data['image']; ?>" class="img-thumbnail" height="100px" width="100px"></span>
                                                </td>
                                                <td>
                                                    <a class="btn btn-success" href="update_hod.php?id=<?php echo $data['id'] ?>"><i class="fa fa-edit"></i></a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger" href="delete_hod.php?id=<?php echo $data['id'] ?>"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $sno = $sno + 1;
