                                        ...
                                        ?>
                                            <tr class="row_1 row_gray">
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        <a class="btn btn-success" name="approve" href="inprogress.php?id=<?php echo $data['id'] ?>">In-Progress</a>
                                                    <?php
                                                    } else if ($data['status'] == 'In-Progress') {
                                                    ?>
                                                        <a class="btn btn-success" name="approve" href="approve.php?id=<?php echo $data['id'] ?>">Completed</a>
                                                    <?php
                                                    } else {
                                                    ?>
