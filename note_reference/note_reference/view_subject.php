	...
	<div class="container">
			<div class="row mb-5">
                ...
                <div class="section-title d-flex justify-content-around text-danger text-center">
                    ...
                    <span class="mt-2">
					<a href="add_subject.php" class="site-btn header-btn">Add Subject</a>
                    </span>
				</div>
                <div class="container my-5 table-responsive newone" id="welcome">
                    ...
                    <tbody>
                        ...
                        <tr class="row_1 row_gray">
                            ...
                            <td>
                            <span ><img src="subject_images/<?php echo $data['logo']; ?>" class="img-thumbnail"
                                    height="100px" width="100px" ></span>
                            </td>
                            <td>
                                <a class="btn btn-success" href="update_subject.php?id=<?php echo $data['id']?>"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="delete_subject.php?id=<?php echo $data['id']?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php
                            $sno=$sno+1;
