	...
	<div class="container">
			<div class="row mb-5">
                ...
                <div class="section-title d-flex justify-content-around text-danger text-center">
					<h2 >Manage Notes</h2>
                    <span class="mt-2">
					<a href="add_notes.php" class="site-btn header-btn">Add Material</a>
                    </span>
				</div>
                <div class="container my-5 table-responsive newone" id="welcome">
                    ...
                    <tbody>
                        ...
                        <tr class="row_1 row_gray">
                            ...
                            <td>
                                <a class="btn btn-success" href="update_notes.php?id=<?php echo $data['id']?>"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="delete_notes.php?id=<?php echo $data['id']?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php
                            $sno=$sno+1;
