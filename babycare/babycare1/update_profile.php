...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">Update Profile</h1>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <h1 class="text-primary text-uppercase mb-2">Update Profile</h1>
        </div>
...
if (isset($_REQUEST['add'])) {
    ...
    if(isset($_FILES['image'])){
        ...
        $res=mysqli_query($conn,$query);
        if($res>0){
            echo "<script>window.location.assign('profile.php?msg=Profile Updated Successfully')</script>";
        }
        else{
            echo "<script>window.location.assign('profile.php?msg=Error While Updation!!')</script>";
        }
    }
}
