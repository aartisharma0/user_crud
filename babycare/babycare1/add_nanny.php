...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4">Add Nanny</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Admin</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">Add Nanny</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <h1 class="text-primary text-uppercase mb-2">Add Nanny</h1>
        </div>
                            ...
                            <form method="post" name="login" onsubmit=" return validateForm()"  enctype="multipart/form-data">
                                <fieldset class="input">
                                    ...
                                    <p id="login-form-password">
                                        ...
                                        <input id="modlgn_passwd" type="date" name="dob" class="inputbox form-control" autocomplete="off" placeholder="Enter Contact" required>
                                    </p>
                                    <p id="login-form-password">
                                    ...
                                    <p id="login-form-password">
                                        ...
                                        <input id="modlgn_passwd" type="text" name="qualification" class="inputbox form-control" autocomplete="off" placeholder="Enter Your Qualification" required>
                                    </p>
                                    <p id="login-form-password">
                                        <label for="modlgn_passwd">Photo</label>
                                        <input id="modlgn_passwd" type="file" name="image" class="inputbox form-control" autocomplete="off" placeholder="Upload Image" required>
                                    </p>
                                    <div class=" row my-4">
...
if (isset($_REQUEST['add'])) {
    ...
    if (isset($_FILES['image'])) {
        ...
        include('config.php');
        $query = "INSERT INTO `nanny`( `name`,`email`,`password`,`contact`,`address`,`dob`,`gender`,`adharcard_id`,`pan_id`,`qualification`,`image`) VALUES ('$hname','$email','$pwd','$contact','$address','$dob','$gender','$adhar','$pan','$qualification','$new_name')";
        // echo $query;
        $res = mysqli_query($conn, $query);
        if ($res > 0) {
            echo "<script>window.location.assign('add_nanny.php?msg=Nanny Added Successfully')</script>";
        } else {
            echo "<script>window.location.assign('add_nanny.php?msg=Nanny Already Exist!')</script>";
        }
    }
}
