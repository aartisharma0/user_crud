...
<div class="container-xxl py-5 page-header position-relative mb-5">
    <div class="container py-5">
        <h1 class="display-2 text-white animated slideInDown mb-4"> Nannies</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Parent</a></li>
                <li class="breadcrumb-item text-white active" aria-current="page">Manage Nannies</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <h1 class="text-primary text-uppercase mb-2">All Nannys</h1>
        </div>
        <div class="row text-center mt-5">
            ...
            ?>
                < <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="book.php?nanny=<?php echo $data['email'] ?>">
