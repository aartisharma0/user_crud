                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" name="name" value="<?php echo $data1['name'] ?>" placeholder="Your Name">
                                                <label for="name">Your Name</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="email" class="form-control border-0" name="email" value="<?php echo $data1['email'] ?>" placeholder="Your Email">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100 py-3" type="submit" name="add">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
